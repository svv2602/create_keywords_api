...
### Формат ссылок на размеры

API автоматически генерирует правильные ссылки на размеры шин в формате:
- `/shiny/w-215/h-55/r-17/` для размера 215/55R17
- `/shiny/w-225/h-45/r-18/` для размера 225/45R18
...
- **Токены:** до 3000 токенов
- **Защита брендов:** Названия брендов (Michelin, Bridgestone, Toyota и др.) остаются на латинице даже в украинском тексте
- **Нормализация украинского:** Автоматическая конвертация случайно введенных латинских символов в кириллицу (кроме брендов)
...
```json
{
  "error": "Missing required parameters: brand, model, language, typical_sizes"
}
```
...
```html
<h2>Підбір шин на Toyota Camry</h2>

<p>Toyota Camry — популярний седан бізнес-класу, який поєднує комфорт, надійність та динаміку. Для цієї моделі важливо підібрати якісні шини, що забезпечать безпеку та комфорт під час їзди.</p>

<h3>Типові розміри шин для Toyota Camry</h3>
<p>Найбільш поширені розміри шин для цієї моделі:</p>
<ul>
  <li><a href="/shiny/w-215/h-55/r-17/">215/55 R17</a> — стандартний розмір для базових комплектацій</li>
  <li><a href="/shiny/w-215/h-60/r-16/">215/60 R16</a> — комфортний варіант для міста</li>
  <li><a href="/shiny/w-225/h-45/r-18/">225/45 R18</a> — спортивний варіант для топових версій</li>
</ul>

<h3>Популярні бренди та їх особливості</h3>
<p>Для <a href="/shiny/auto/toyota/camry/">Toyota Camry</a> рекомендуємо шини від перевірених виробників: Michelin, Bridgestone, Continental, Nokian. Влітку підійдуть моделі з асиметричним протектором, взимку — скандинавські шипові або липучки.</p>

<h3>Рекомендації з підбору шин</h3>
<ul>
  <li>Індекси навантаження та швидкості: 91-99 H/V</li>
  <li>Вибір сезонності: літні, зимові або всесезонні</li>
  <li>Малюнок протектора під стиль водіння</li>
  <li>Рекомендований тиск: 2.2-2.4 бар</li>
</ul>

<h3>Переваги ProKoleso</h3>
<p>Широкий вибір шин від перевірених брендів, швидка доставка по Україні, професійна консультація щодо підбору.</p>

<p>Купити шини на Toyota Camry у нашому інтернет-магазині просто та вигідно — оформіть замовлення онлайн прямо зараз!</p>
```

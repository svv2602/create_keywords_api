...
module ServiceReview
  ...
  def generate_review(query_params, arr_review_length, season = nil, gender = nil)
    ...
    if rand(100) < 40
      topics += "4. НАЗВАНИЕ МОДЕЛИ: Используй транслитерацию на русском языке (Pilot Sport → Пайлот Спорт).\n"
    else
      topics += "4. НАЗВАНИЕ МОДЕЛИ: Используй оригинальное латинское название модели шин.\n"
    end
